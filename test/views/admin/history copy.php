...
<body class="text-dark">
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <ul class="nav nav-pills mb-3 mx-4 mt-3" id="pills-tab" role="tablist">
                <li class="nav-item mx-3" role="presentation">
                    <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill"
                        data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home"
                        aria-selected="true">DISPOSE HISTORY</button>
                </li>
                <li class="nav-item mx-3" role="presentation">
                    <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill"
                        data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile"
                        aria-selected="false">RETURNED HISTORY</button>
                </li>
                <li class="nav-item mx-3" role="presentation">
                    <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                        data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact"
                        aria-selected="false">DELETED HISTORY</button>
                </li>
            </ul>
            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab"
                    ...
                    <main class="content mx-4 items-align-center px-3 mb-4">
                                            ...
                                            <table class="table" id="myTable" style="font-size: 14px">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="text-center">Date Dispose</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php
                                                    // pull the method selectFruits() out of function.php to get the fruits
                                                    $getDispose = fetchDispose();

                                                    //populate the table data by looping the array result
                                                    while ($dispose = $getDispose->fetch(PDO::FETCH_ASSOC)) {
                                                        ?>
                                                        <tr>
                                                            <td class="text-center">
                                                                <?= $dispose['smi_dispose_id'] ?>
                                                            </td>
                                                            <td class="text-center">
                                                                <?= $dispose['smi_dispose_equipmentName'] ?>
                                                            </td>
                                                            <td class="text-center">
                                                                <?= $dispose['smi_dispose_equipmentQty'] ?>
                                                            </td>
                                                            <td class="text-center">
                                                                <?= $dispose['smi_dispose_studentName'] ?>
                                                            </td>
                                                            <td class="text-center">
                                                                <?= $dispose['smi_dispose_studentId'] ?>
                                                            </td>
                                                            <td class="text-center">
                                                                <?= ucwords($dispose['smi_dispose_reason']) ?>
                                                            </td>
                                                            <td class="text-center">
                                                                <?= date("M d, Y g:i A", strtotime($dispose['smi_dispose_date'])) ?>
                                                            </td>
                                                        </tr>
                                                    <?php } ?>
                                                </tbody>
